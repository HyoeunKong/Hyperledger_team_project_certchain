...
module.exports={
    update_cert: async function(cert_key,title, grade, serial, date, create_at){
        try{
            ...
            const userExists = await wallet.exists('user5');
              ...
              await contract.submitTransaction('update_cert',cert_key, title, grade, serial, date, create_at);
              console.log('cert 업로드');
